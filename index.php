...
echo '##### GROWTH RATES #####';
echo PHP_EOL;
echo 'Actual Average Height Growth Rate: '.$treeData->getActualAnnualHeightGrowthRate()->describe();
echo PHP_EOL;
echo 'Default Average Height Growth Rate: '.$treeData->getAverageAnnualHeightGrowthRate()->describe();
echo PHP_EOL;
echo 'Actual Average Circumference Growth Rate: '.$treeData->getActualAverageCircumferenceGrowthRate()->describe();
echo PHP_EOL;
