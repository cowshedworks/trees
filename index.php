...
echo '##### GROWTH RATES #####';
echo PHP_EOL;
echo 'Height Growth Rates: '.$treeData->describeActualHeightGrowthRate();
echo PHP_EOL;
echo 'Height Growth Rates (Default average): '.$treeData->describeAverageHeightGrowthRate();
echo PHP_EOL;
echo 'Circumference Growth Rates: '.$treeData->describeActualCircumferenceGrowthRate();
echo PHP_EOL;
echo 'Circumference Growth Rates (Default average): '.$treeData->describeAverageCircumferenceGrowthRate();
echo PHP_EOL;
